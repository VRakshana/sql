...
create table Passenger(
    ...
    constraint FMS_pgrid unique(passenger_id)
);
desc passenger;
...
create table Flight(
    ...
    constraint fms_fltid unique(flight_id)
);
...
create table booking(
    ...
    constraint cst_bid unique(booking_id),
    constraint cst_fid foreign key(flight_id)
...
create table booking_details(
    ...
    constraint fms_fkbid foreign key(Booking_id) references booking(booking_id),
    constraint fms_fkfid foreign key(passenger_id) references passenger(passenger_id)
);
